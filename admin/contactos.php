        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(0,0,0);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="projetos.php"><i class="far fa-folder-open"></i><span>Adicionar Projetos</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="contactos.php"><i class="far fa-comment"></i><span>Contactos</span></a></li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Contactos</h3>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="card shadow mb-5">
                                <div class="card-header py-3">
                                    <p class="text-primary m-0 fw-bold" style="color: rgb(0,0,0) !important;">Enviar Email</p>
                                </div>
                                <div class="card-body">
                                
                                    <iframe src="https://webmail.xmhosts.pt" style="width: 1000px; height: 600px;"></iframe>
